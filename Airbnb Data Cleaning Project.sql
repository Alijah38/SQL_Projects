...
-- CHECKED FOR DUPLICATES *FOUND NO DUPLICATE RECORDS
...
-- STANDARDIZED BLANKS IN NEIGHBOURHOOD GROUP
...
-- STANDARDIZED BLANKS IN COUNTRY
...
-- STANDARDIZED COLUMNS WITH BLANKS TO NULL
...
-- STANDARDIZED PRICE AND SERVICE FEE BY REMOVING $ SYMBOL
...
-- STANDARDIZED DATA TYPE FOR DATE, LAT, LONG COLUMNS
...
-- STANDARDIZED FIRST LETTER FOR TEXT COLUMNS
